...
export const homeContent: Record<Locale, HomeContent> = {
  'en-us': {
    ...
    towns: [
      ...
      {
        name: 'Anacapri', slug: 'anacapri',
        tagline: 'The quiet side of Capri',
        description: 'Anacapri sits at 275 m above sea level on the island\'s western slope: a quieter, more authentic alternative to Capri town, with Villa San Michele, the Mount Solaro chairlift, and the panoramic Blue Grotto trail.',
        highlights: ['Villa San Michele', 'Mount Solaro chairlift', 'Blue Grotto', 'Migliera viewpoint', 'Punta Carena Lighthouse'],
        area: 'isole',
      },
      {
        name: 'Forio', slug: 'forio',
        tagline: 'The artists\' island on Ischia',
        description: 'Forio is the largest seaside town on Ischia\'s western coast, beloved for its dramatic sunsets, La Mortella botanical gardens (William Walton\'s home), and the Poseidon thermal park carved into the cliffs of Citara Bay.',
        highlights: ['La Mortella gardens', 'Poseidon thermal park', 'Citara beach', 'Soccorso church (sunset)', 'Sorgeto thermal bay'],
        area: 'isole',
      },
      {
  ...
  'de-de': {
    ...
    towns: [
      ...
      {
        name: 'Anacapri', slug: 'anacapri',
        tagline: 'Die ruhige Seite von Capri',
        description: 'Anacapri liegt auf 275 m Höhe am Westhang der Insel: eine ruhigere, authentischere Alternative zur Stadt Capri, mit der Villa San Michele, dem Sessellift auf den Monte Solaro und dem Panoramaweg zur Blauen Grotte.',
        highlights: ['Villa San Michele', 'Sessellift Monte Solaro', 'Blaue Grotte', 'Aussichtspunkt Migliera', 'Leuchtturm Punta Carena'],
        area: 'isole',
      },
      {
        name: 'Forio', slug: 'forio',
        tagline: 'Die Künstlerinsel auf Ischia',
        description: 'Forio ist die größte Küstenstadt an der Westseite Ischias, bekannt für ihre spektakulären Sonnenuntergänge, die botanischen Gärten La Mortella (William Waltons Wohnsitz) und das Thermalbad Poseidon in den Klippen der Citara-Bucht.',
        highlights: ['Gärten La Mortella', 'Thermalpark Poseidon', 'Strand Citara', 'Soccorso-Kirche (Sonnenuntergang)', 'Thermalbucht Sorgeto'],
        area: 'isole',
      },
      {
        name: 'Sorrento', slug: 'sorrento',
  ...
  'fr-fr': {
    ...
    towns: [
      ...
      {
        name: 'Anacapri', slug: 'anacapri',
        tagline: 'Le côté tranquille de Capri',
        description: 'Anacapri se trouve à 275 m d\'altitude sur le versant ouest de l\'île : une alternative plus tranquille et plus authentique à Capri ville, avec la Villa San Michele, le télésiège du Mont Solaro et le sentier panoramique vers la Grotte Bleue.',
        highlights: ['Villa San Michele', 'Télésiège du Mont Solaro', 'Grotte Bleue', 'Belvédère de Migliera', 'Phare de Punta Carena'],
        area: 'isole',
      },
      {
        name: 'Forio', slug: 'forio',
        tagline: 'L\'île des artistes à Ischia',
        description: 'Forio est la plus grande ville côtière de l\'ouest d\'Ischia, célèbre pour ses couchers de soleil spectaculaires, les jardins botaniques La Mortella (résidence de William Walton) et le parc thermal Poseidon creusé dans les falaises de la baie de Citara.',
        highlights: ['Jardins La Mortella', 'Parc thermal Poseidon', 'Plage de Citara', 'Église du Soccorso (coucher de soleil)', 'Baie thermale de Sorgeto'],
        area: 'isole',
      },
      {
        name: 'Sorrento', slug: 'sorrento',
  ...
  'es-es': {
    ...
    towns: [
      ...
      {
        name: 'Anacapri', slug: 'anacapri',
        tagline: 'El lado tranquilo de Capri',
        description: 'Anacapri se encuentra a 275 m de altitud en la vertiente occidental de la isla: una alternativa más tranquila y auténtica a Capri ciudad, con Villa San Michele, el telesilla del Monte Solaro y el sendero panorámico a la Gruta Azul.',
        highlights: ['Villa San Michele', 'Telesilla del Monte Solaro', 'Gruta Azul', 'Mirador de Migliera', 'Faro de Punta Carena'],
        area: 'isole',
      },
      {
        name: 'Forio', slug: 'forio',
        tagline: 'La isla de los artistas en Ischia',
        description: 'Forio es la ciudad costera más grande del oeste de Ischia, célebre por sus espectaculares atardeceres, los jardines botánicos La Mortella (residencia de William Walton) y el parque termal Poseidon excavado en los acantilados de la bahía de Citara.',
        highlights: ['Jardines La Mortella', 'Parque termal Poseidon', 'Playa de Citara', 'Iglesia del Soccorso (atardecer)', 'Bahía termal de Sorgeto'],
        area: 'isole',
      },
      {
        name: 'Sorrento', slug: 'sorrento',
  ...
  'it-it': {
    ...
    towns: [
      ...
      {
        name: 'Anacapri', slug: 'anacapri',
        tagline: 'Il lato tranquillo di Capri',
        description: 'Anacapri si trova a 275 m d\'altitudine sul versante occidentale dell\'isola: un\'alternativa piu tranquilla e autentica a Capri citta, con Villa San Michele, la seggiovia per il Monte Solaro e il sentiero panoramico alla Grotta Azzurra.',
        highlights: ['Villa San Michele', 'Seggiovia del Monte Solaro', 'Grotta Azzurra', 'Belvedere della Migliera', 'Faro di Punta Carena'],
        area: 'isole',
      },
      {
        name: 'Forio', slug: 'forio',
        tagline: 'L\'isola degli artisti a Ischia',
        description: 'Forio e la maggiore citta costiera della parte occidentale di Ischia, celebre per i tramonti spettacolari, i Giardini La Mortella (dimora di William Walton) e il parco termale Poseidon scavato nelle scogliere della baia di Citara.',
        highlights: ['Giardini La Mortella', 'Parco termale Poseidon', 'Spiaggia di Citara', 'Chiesa del Soccorso (tramonto)', 'Baia termale di Sorgeto'],
        area: 'isole',
      },
      {
        name: 'Sorrento', slug: 'sorrento',
