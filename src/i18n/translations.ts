...
export const slugMap: Record<string, SlugMap> = {
  ...
  'spiaggia-di-ieranto': { 'en-us': 'beaches/sorrentine-peninsula/spiaggia-di-ieranto', 'de-de': 'strande/sorrentinische-halbinsel/spiaggia-di-ieranto', 'fr-fr': 'plages/peninsule-sorrentine/spiaggia-di-ieranto', 'es-es': 'playas/peninsula-sorrentina/spiaggia-di-ieranto', 'it-it': 'penisola-sorrentina/spiaggia-di-ieranto' },
