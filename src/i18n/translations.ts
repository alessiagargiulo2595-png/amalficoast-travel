...
export const translations: Record<Locale, Translations> = {
  ...
  'de-de': {
    ...
    footer: {
      ...
      contact_email: 'hello@amalficoast-travel.com',
      copyright: '© 2026 Amalfi & Sorrento Coast. Alle Rechte vorbehalten.',
      tagline: 'Amalfi & Sorrento Coast - Campania, Southern Italy',
    },
    meta: {
  ...
  'fr-fr': {
    ...
    footer: {
      ...
      contact_email: 'hello@amalficoast-travel.com',
      copyright: '© 2026 Amalfi & Sorrento Coast. Tous droits réservés.',
      tagline: 'Amalfi & Sorrento Coast - Campania, Southern Italy',
    },
    meta: {
      ...
      beaches_title: 'Plages Amalfi 2026 | Les 12 Plus Belles Plages de la Côte Amalfitaine',
      beaches_description: 'Les plus belles plages de la côte amalfitaine : criques secrètes, plage Amalfi, Positano, Capri et Ischia. Guide 2026 avec tarifs, accès et conseils pratiques.',
  ...
  'es-es': {
    ...
    footer: {
      ...
      contact_email: 'hello@amalficoast-travel.com',
      copyright: '© 2026 Amalfi & Sorrento Coast. Todos los derechos reservados.',
      tagline: 'Amalfi & Sorrento Coast - Campania, Southern Italy',
    },
    meta: {
      ...
      beaches_title: 'Playas Costa Amalfitana Italia 2026 | Las 12 Mejores Calas y Playas',
      beaches_description: 'Las mejores playas de la costa amalfitana Italia: calas secretas, playas de guijarros en Positano, Capri e Ischia. Guía 2026 con precios, acceso y consejos prácticos.',
  ...
  'it-it': {
    ...
    footer: {
      ...
      contact_email: 'hello@amalficoast-travel.com',
      copyright: '© 2026 Amalfi & Sorrento Coast. Tutti i diritti riservati.',
      tagline: 'Amalfi & Sorrento Coast - Campania, Southern Italy',
    },
    meta: {
...
export const slugMap: Record<string, SlugMap> = {
  ...
  'fornillo-positano': { 'en-us': 'beaches/amalfi-coast/fornillo-positano', 'de-de': 'strande/amalfikueste/fornillo-positano', 'fr-fr': 'plages/cote-amalfitaine/fornillo-positano', 'es-es': 'playas/costa-amalfitana/fornillo-positano', 'it-it': 'spiagge/costiera-amalfitana/fornillo-positano' },
  'marina-di-conca': { 'en-us': 'beaches/amalfi-coast/marina-di-conca', 'de-de': 'strande/amalfikueste/marina-di-conca', 'fr-fr': 'plages/cote-amalfitaine/marina-di-conca', 'es-es': 'playas/costa-amalfitana/marina-di-conca', 'it-it': 'spiagge/costiera-amalfitana/marina-di-conca' },
  'gavitella-praiano': { 'en-us': 'beaches/amalfi-coast/gavitella-praiano', 'de-de': 'strande/amalfikueste/gavitella-praiano', 'fr-fr': 'plages/cote-amalfitaine/gavitella-praiano', 'es-es': 'playas/costa-amalfitana/gavitella-praiano', 'it-it': 'spiagge/costiera-amalfitana/gavitella-praiano' },
  ...
  'sorrento-vs-positano': { 'en-us': 'blog/sorrento-vs-positano', 'de-de': 'blog/sorrento-vs-positano', 'fr-fr': 'blog/sorrento-vs-positano', 'es-es': 'blog/sorrento-vs-positano', 'it-it': 'blog/sorrento-vs-positano' },
  'positano-vs-amalfi': { 'en-us': 'blog/positano-vs-amalfi', 'de-de': 'blog/positano-vs-amalfi', 'fr-fr': 'blog/positano-vs-amalfi', 'es-es': 'blog/positano-vs-amalfi', 'it-it': 'blog/positano-vs-amalfi' },
  'sorrento-vs-amalfi': { 'en-us': 'blog/sorrento-vs-amalfi', 'de-de': 'blog/sorrento-vs-amalfi', 'fr-fr': 'blog/sorrento-vs-amalfi', 'es-es': 'blog/sorrento-vs-amalfi', 'it-it': 'blog/sorrento-vs-amalfi' },
  'capri-vs-ischia': { 'en-us': 'blog/capri-vs-ischia', 'de-de': 'blog/capri-vs-ischia', 'fr-fr': 'blog/capri-vs-ischia', 'es-es': 'blog/capri-vs-ischia', 'it-it': 'blog/capri-vs-ischia' },
  'praiano-vs-positano': { 'en-us': 'blog/praiano-vs-positano', 'de-de': 'blog/praiano-vs-positano', 'fr-fr': 'blog/praiano-vs-positano', 'es-es': 'blog/praiano-vs-positano', 'it-it': 'blog/praiano-vs-positano' },
  'maiori-vs-minori': { 'en-us': 'blog/maiori-vs-minori', 'de-de': 'blog/maiori-vs-minori', 'fr-fr': 'blog/maiori-vs-minori', 'es-es': 'blog/maiori-vs-minori', 'it-it': 'blog/maiori-vs-minori' },
  'procida-vs-ischia': { 'en-us': 'blog/procida-vs-ischia', 'de-de': 'blog/procida-vs-ischia', 'fr-fr': 'blog/procida-vs-ischia', 'es-es': 'blog/procida-vs-ischia', 'it-it': 'blog/procida-vs-ischia' },
...
export const pathSegments: Array<Record<Locale, string>> = [
  ...
  { 'en-us': 'boat-tours',                       'de-de': 'bootstouren',                        'fr-fr': 'tours-en-bateau',                   'es-es': 'tours-en-barco',                    'it-it': 'tour-barca'                        },
  { 'en-us': 'cooking-class',                    'de-de': 'kochkurs',                           'fr-fr': 'cours-de-cuisine',                  'es-es': 'clase-cocina',                      'it-it': 'cooking-class'                     },
  { 'en-us': 'weddings',                         'de-de': 'hochzeiten',                         'fr-fr': 'mariages',                          'es-es': 'bodas',                             'it-it': 'matrimoni'                         },
  { 'en-us': 'starred-restaurants',              'de-de': 'sterne-restaurants',                  'fr-fr': 'restaurants-etoiles',               'es-es': 'restaurantes-estrella',             'it-it': 'ristoranti-stellati'               },
  { 'en-us': 'limoncello-tour',                  'de-de': 'limoncello-tour',                    'fr-fr': 'tour-limoncello',                   'es-es': 'tour-limoncello',                   'it-it': 'limoncello-tour'                   },
  { 'en-us': 'mozzarella-experience',            'de-de': 'mozzarella-erlebnis',                 'fr-fr': 'experience-mozzarella',             'es-es': 'experiencia-mozzarella',            'it-it': 'mozzarella-experience'             },
  ...
  // When to visit
  { 'en-us': 'when-to-visit',        'de-de': 'reisezeit',           'fr-fr': 'quand-visiter',        'es-es': 'cuando-visitar',       'it-it': 'quando-visitare'      },
  // Destinations page
  { 'en-us': 'destinations',         'de-de': 'reiseziele',          'fr-fr': 'destinations',         'es-es': 'destinos',             'it-it': 'destinazioni'         },
  // Guide sub-pages
  ...
  { 'en-us': 'amalfi-coast-from-naples',          'de-de': 'amalfikueste-von-neapel',           'fr-fr': 'cote-amalfitaine-depuis-naples',    'es-es': 'costa-amalfitana-desde-napoles',    'it-it': 'costiera-amalfitana-da-napoli'     },
  { 'en-us': 'amalfi-coast-from-salerno',         'de-de': 'amalfikueste-von-salerno',           'fr-fr': 'cote-amalfitaine-depuis-salerne',   'es-es': 'costa-amalfitana-desde-salerno',    'it-it': 'costiera-amalfitana-da-salerno'    },
  { 'en-us': 'capri-from-sorrento',               'de-de': 'capri-von-sorrent',                  'fr-fr': 'capri-depuis-sorrente',             'es-es': 'capri-desde-sorrento',              'it-it': 'capri-da-sorrento'                 },
  { 'en-us': 'sorrentine-peninsula-from-naples',  'de-de': 'sorrentinische-halbinsel-von-neapel','fr-fr': 'peninsule-sorrentine-depuis-naples','es-es': 'peninsula-sorrentina-desde-napoles','it-it': 'penisola-sorrentina-da-napoli'     },
  { 'en-us': 'path-of-the-gods-trek',             'de-de': 'weg-der-goetter-trekking',           'fr-fr': 'sentier-des-dieux-trek',            'es-es': 'sendero-de-los-dioses-trek',        'it-it': 'trekking-sentiero-degli-dei'       },
  // Itinerary detail slugs - 3 days
  { 'en-us': 'classic-amalfi-coast',              'de-de': 'klassische-amalfikueste',            'fr-fr': 'cote-amalfitaine-classique',        'es-es': 'costa-amalfitana-clasica',          'it-it': 'classico-costiera-amalfitana'      },
  { 'en-us': 'islands-ischia-procida',            'de-de': 'inseln-ischia-procida',              'fr-fr': 'iles-ischia-procida',               'es-es': 'islas-ischia-procida',              'it-it': 'isole-ischia-procida'              },
  { 'en-us': 'sorrento-pompeii-history',          'de-de': 'sorrent-pompeji-geschichte',         'fr-fr': 'sorrente-pompei-histoire',          'es-es': 'sorrento-pompeya-historia',         'it-it': 'sorrento-pompei-storia'            },
  ...
  { 'en-us': 'comfortable-beaches',               'de-de': 'komfortable-ausgestattete-strande',  'fr-fr': 'plages-confortables-equipees',      'es-es': 'playas-comodas-equipadas',          'it-it': 'spiagge-comode-attrezzate'         },
  { 'en-us': 'emerald-grotto',                    'de-de': 'smaragd-grotte',                     'fr-fr': 'grotte-emeraude',                   'es-es': 'gruta-esmeralda',                   'it-it': 'grotta-dello-smeraldo'             },
  { 'en-us': 'ferriere-valley',                   'de-de': 'ferriere-tal',                       'fr-fr': 'vallee-des-ferriere',               'es-es': 'valle-ferriere',                    'it-it': 'valle-delle-ferriere'              },
  { 'en-us': 'sunset-beaches',                    'de-de': 'sonnenuntergang-strande',             'fr-fr': 'coucher-soleil-plages',             'es-es': 'puesta-de-sol-playas',              'it-it': 'tramonto-spiaggia-costiera'        },
  { 'en-us': 'wild-remote-beaches',               'de-de': 'wilde-abgelegene-strande',            'fr-fr': 'oasis-sauvages-plages',             'es-es': 'oasis-salvajes-playas',             'it-it': 'oasi-selvagge-spiagge-mare'        },
  ...
  { 'en-us': 'sorrento-vs-positano',               'de-de': 'sorrento-vs-positano',                'fr-fr': 'sorrento-vs-positano',              'es-es': 'sorrento-vs-positano',              'it-it': 'sorrento-vs-positano'              },
  { 'en-us': 'positano-vs-amalfi',                 'de-de': 'positano-vs-amalfi',                  'fr-fr': 'positano-vs-amalfi',                'es-es': 'positano-vs-amalfi',                'it-it': 'positano-vs-amalfi'                },
  { 'en-us': 'sorrento-vs-amalfi',                 'de-de': 'sorrento-vs-amalfi',                  'fr-fr': 'sorrento-vs-amalfi',                'es-es': 'sorrento-vs-amalfi',                'it-it': 'sorrento-vs-amalfi'                },
  { 'en-us': 'capri-vs-ischia',                    'de-de': 'capri-vs-ischia',                     'fr-fr': 'capri-vs-ischia',                   'es-es': 'capri-vs-ischia',                   'it-it': 'capri-vs-ischia'                   },
  { 'en-us': 'praiano-vs-positano',                'de-de': 'praiano-vs-positano',                 'fr-fr': 'praiano-vs-positano',               'es-es': 'praiano-vs-positano',               'it-it': 'praiano-vs-positano'               },
  { 'en-us': 'maiori-vs-minori',                   'de-de': 'maiori-vs-minori',                    'fr-fr': 'maiori-vs-minori',                  'es-es': 'maiori-vs-minori',                  'it-it': 'maiori-vs-minori'                  },
  { 'en-us': 'procida-vs-ischia',                  'de-de': 'procida-vs-ischia',                   'fr-fr': 'procida-vs-ischia',                 'es-es': 'procida-vs-ischia',                 'it-it': 'procida-vs-ischia'                 },
  ...
  { 'en-us': 'ravello',                           'de-de': 'ravello',                            'fr-fr': 'ravello',                           'es-es': 'ravello',                           'it-it': 'ravello'                           },
  { 'en-us': 'praiano',                           'de-de': 'praiano',                            'fr-fr': 'praiano',                           'es-es': 'praiano',                           'it-it': 'praiano'                           },
  { 'en-us': 'marina-di-praia',                   'de-de': 'marina-di-praia',                    'fr-fr': 'marina-di-praia',                   'es-es': 'marina-di-praia',                   'it-it': 'marina-di-praia'                   },
  { 'en-us': 'maiori',                            'de-de': 'maiori',                             'fr-fr': 'maiori',                            'es-es': 'maiori',                            'it-it': 'maiori'                            },
  { 'en-us': 'minori',                            'de-de': 'minori',                             'fr-fr': 'minori',                            'es-es': 'minori',                            'it-it': 'minori'                            },
  { 'en-us': 'vietri-sul-mare',                   'de-de': 'vietri-sul-mare',                    'fr-fr': 'vietri-sul-mare',                   'es-es': 'vietri-sul-mare',                   'it-it': 'vietri-sul-mare'                   },
  ...
  { 'en-us': 'vico-equense',                      'de-de': 'vico-equense',                       'fr-fr': 'vico-equense',                      'es-es': 'vico-equense',                      'it-it': 'vico-equense'                      },
  { 'en-us': 'massa-lubrense',                    'de-de': 'massa-lubrense',                     'fr-fr': 'massa-lubrense',                    'es-es': 'massa-lubrense',                    'it-it': 'massa-lubrense'                    },
  { 'en-us': 'sant-agnello',                      'de-de': 'sant-agnello',                       'fr-fr': 'sant-agnello',                      'es-es': 'sant-agnello',                      'it-it': 'sant-agnello'                      },
  // Event detail slugs (same in all languages)
  { 'en-us': 'capodanno-bizantino',               'de-de': 'capodanno-bizantino',                'fr-fr': 'capodanno-bizantino',               'es-es': 'capodanno-bizantino',               'it-it': 'capodanno-bizantino'              },
  { 'en-us': 'festa-san-gennaro-praiano',         'de-de': 'festa-san-gennaro-praiano',          'fr-fr': 'festa-san-gennaro-praiano',         'es-es': 'festa-san-gennaro-praiano',         'it-it': 'festa-san-gennaro-praiano'        },
  { 'en-us': 'festa-sant-andrea-amalfi',          'de-de': 'festa-sant-andrea-amalfi',           'fr-fr': 'festa-sant-andrea-amalfi',          'es-es': 'festa-sant-andrea-amalfi',          'it-it': 'festa-sant-andrea-amalfi'         },
  { 'en-us': 'festival-limone-minori',            'de-de': 'festival-limone-minori',             'fr-fr': 'festival-limone-minori',            'es-es': 'festival-limone-minori',            'it-it': 'festival-limone-minori'           },
  ...
  { 'en-us': 'luminaria-san-domenico-praiano',    'de-de': 'luminaria-san-domenico-praiano',     'fr-fr': 'luminaria-san-domenico-praiano',    'es-es': 'luminaria-san-domenico-praiano',    'it-it': 'luminaria-san-domenico-praiano'   },
  { 'en-us': 'notte-blu-vietri',                  'de-de': 'notte-blu-vietri',                   'fr-fr': 'notte-blu-vietri',                  'es-es': 'notte-blu-vietri',                  'it-it': 'notte-blu-vietri'                 },
  { 'en-us': 'positano-mare-sole-cultura',        'de-de': 'positano-mare-sole-cultura',         'fr-fr': 'positano-mare-sole-cultura',        'es-es': 'positano-mare-sole-cultura',        'it-it': 'positano-mare-sole-cultura'       },
  { 'en-us': 'ravello-festival',                  'de-de': 'ravello-festival',                   'fr-fr': 'ravello-festival',                  'es-es': 'ravello-festival',                  'it-it': 'ravello-festival'                 },
  { 'en-us': 'regata-storica-amalfi',             'de-de': 'regata-storica-amalfi',              'fr-fr': 'regata-storica-amalfi',             'es-es': 'regata-storica-amalfi',             'it-it': 'regata-storica-amalfi'            },
  { 'en-us': 'sagra-del-pesce-positano',          'de-de': 'sagra-del-pesce-positano',           'fr-fr': 'sagra-del-pesce-positano',          'es-es': 'sagra-del-pesce-positano',          'it-it': 'sagra-del-pesce-positano'         },
  { 'en-us': 'anacapri-settembre-borgo',          'de-de': 'anacapri-settembre-borgo',           'fr-fr': 'anacapri-settembre-borgo',          'es-es': 'anacapri-settembre-borgo',          'it-it': 'anacapri-settembre-borgo'         },
  { 'en-us': 'ischia-global-film-festival',       'de-de': 'ischia-global-film-festival',        'fr-fr': 'ischia-global-film-festival',       'es-es': 'ischia-global-film-festival',       'it-it': 'ischia-global-film-festival'      },
  { 'en-us': 'sagra-del-mare-graziella-procida',  'de-de': 'sagra-del-mare-graziella-procida',   'fr-fr': 'sagra-del-mare-graziella-procida',  'es-es': 'sagra-del-mare-graziella-procida',  'it-it': 'sagra-del-mare-graziella-procida' },
  { 'en-us': 'festa-sant-antonino',               'de-de': 'festa-sant-antonino',                'fr-fr': 'festa-sant-antonino',               'es-es': 'festa-sant-antonino',               'it-it': 'festa-sant-antonino'              },
  { 'en-us': 'gustamincanto-vico-equense',        'de-de': 'gustamincanto-vico-equense',         'fr-fr': 'gustamincanto-vico-equense',        'es-es': 'gustamincanto-vico-equense',        'it-it': 'gustamincanto-vico-equense'       },
  { 'en-us': 'madonna-della-libera',              'de-de': 'madonna-della-libera',               'fr-fr': 'madonna-della-libera',              'es-es': 'madonna-della-libera',              'it-it': 'madonna-della-libera'             },
  ...
  { 'en-us': 'marina-del-cantone',                'de-de': 'marina-del-cantone',                 'fr-fr': 'marina-del-cantone',               'es-es': 'marina-del-cantone',               'it-it': 'marina-del-cantone'              },
  { 'en-us': 'regina-giovanna',                   'de-de': 'regina-giovanna',                    'fr-fr': 'regina-giovanna',                  'es-es': 'regina-giovanna',                  'it-it': 'regina-giovanna'                 },
  { 'en-us': 'marina-di-praia',                   'de-de': 'marina-di-praia',                    'fr-fr': 'marina-di-praia',                  'es-es': 'marina-di-praia',                  'it-it': 'marina-di-praia'                 },
  { 'en-us': 'fornillo-positano',                 'de-de': 'fornillo-positano',                  'fr-fr': 'fornillo-positano',                'es-es': 'fornillo-positano',                'it-it': 'fornillo-positano'               },
  { 'en-us': 'marina-di-conca',                   'de-de': 'marina-di-conca',                    'fr-fr': 'marina-di-conca',                  'es-es': 'marina-di-conca',                  'it-it': 'marina-di-conca'                 },
  { 'en-us': 'gavitella-praiano',                 'de-de': 'gavitella-praiano',                  'fr-fr': 'gavitella-praiano',                'es-es': 'gavitella-praiano',                'it-it': 'gavitella-praiano'               },
];
...
function buildRedirectMap(): Record<string, string> {
  ...
  const redirectRules = [
    ...
    ['/es-es/islas/', '/es-es/islas/'],
    ['/es-es/islas/capri/', '/es-es/islas/capri/'],
    ['/es-es/ischia/', '/es-es/islas/ischia/'],
    ['/es-es/procida/', '/es-es/islas/procida/'],
    ['/fr-fr/iles/capri/', '/fr-fr/iles/capri/'],
    ['/fr-fr/ischia/', '/fr-fr/iles/ischia/'],
    ['/fr-fr/', '/fr-fr/iles/capri/'],
    ['/fr-fr/iles/capri/', '/fr-fr/iles/anacapri/'],
    ...
    ['/de-de/amalfikueste/amalfi/', '/de-de/amalfikueste/amalfi/'],
    ['/de-de/amalfikueste/positano/', '/de-de/amalfikueste/positano/'],
    ['/de-de/strände/amalfiküste/spiaggia-grande-positano/', '/de-de/strande/amalfikueste/spiaggia-grande-positano/'],
    ...
    // PENISOLA SORRENTINA
    ['/en-us/sorrento-peninsula/sorrento/', '/en-us/sorrento-peninsula/sorrento/'],
    ['/en-us/', '/en-us/sorrento-peninsula/massa-lubrense/'],
    ['/en-us/', '/en-us/sorrento-peninsula/sant-agnello/'],
    ['/en-us/', '/en-us/sorrento-peninsula/vico-equense/'],
    ['/fr-fr/peninsule-sorrentine/sorrente/', '/fr-fr/peninsule-sorrentine/sorrente/'],
    ...
    ['/es-es/peninsula-sorrentina/sorrente/', '/es-es/peninsula-sorrentina/sorrento/'],
    ...
    ['/de-de/strande/sorrentinische-halbinsel/cala-mitigliano/', '/de-de/strande/sorrentinische-halbinsel/cala-mitigliano/'],
    ['/de-de/strande/sorrentinische-halbinsel/marina-del-cantone/', '/de-de/strande/sorrentinische-halbinsel/marina-del-cantone/'],
    ['/de-de/strande/sorrentinische-halbinsel/regina-giovanna/', '/de-de/strande/sorrentinische-halbinsel/regina-giovanna/'],
    ['/de-de/strande/sorrentinische-halbinsel/spiaggia-di-ieranto/', '/de-de/strande/sorrentinische-halbinsel/spiaggia-di-ieranto/'],
    ...
    ['/en-us/beaches/sorrentine-peninsula/spiaggia-di-ieranto/', '/en-us/beaches/sorrentine-peninsula/spiaggia-di-ieranto/'],
    ['/en-us/beaches/sorrentine-peninsula/ieranto-bay/', '/en-us/beaches/sorrentine-peninsula/spiaggia-di-ieranto/'],
    ['/de-de/ratgeber/anreise/', '/de-de/ratgeber/anreise/'],
    ['/de-de/ratgeber/reisezeit/', '/de-de/ratgeber/reisezeit/'],
  ];
