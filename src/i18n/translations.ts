...
export const slugMap: Record<string, SlugMap> = {
  ...
  sorrento: {
    ...
    'de-de': 'sorrentiner-halbinsel/sorrent',
  ...
  'vico-equense': {
    ...
    'de-de': 'sorrentiner-halbinsel/vico-equense',
  ...
  'massa-lubrense': {
    ...
    'de-de': 'sorrentiner-halbinsel/massa-lubrense',
  ...
  'sant-agnello': {
    ...
    'de-de': 'sorrentiner-halbinsel/sant-agnello',
  ...
  'festa-sant-antonino': { 'en-us': 'events/sorrento-peninsula/festa-sant-antonino', 'de-de': 'veranstaltungen/sorrentiner-halbinsel/festa-sant-antonino', 'fr-fr': 'evenements/peninsule-sorrentine/festa-sant-antonino', 'es-es': 'eventos/peninsula-sorrentina/festa-sant-antonino', 'it-it': 'eventi/penisola-sorrentina/festa-sant-antonino' },
  'gustamincanto-vico-equense': { 'en-us': 'events/sorrento-peninsula/gustamincanto-vico-equense', 'de-de': 'veranstaltungen/sorrentiner-halbinsel/gustamincanto-vico-equense', 'fr-fr': 'evenements/peninsule-sorrentine/gustamincanto-vico-equense', 'es-es': 'eventos/peninsula-sorrentina/gustamincanto-vico-equense', 'it-it': 'eventi/penisola-sorrentina/gustamincanto-vico-equense' },
  'madonna-della-libera': { 'en-us': 'events/sorrento-peninsula/madonna-della-libera', 'de-de': 'veranstaltungen/sorrentiner-halbinsel/madonna-della-libera', 'fr-fr': 'evenements/peninsule-sorrentine/madonna-della-libera', 'es-es': 'eventos/peninsula-sorrentina/madonna-della-libera', 'it-it': 'eventi/penisola-sorrentina/madonna-della-libera' },
  'sagra-limone-massa-lubrense': { 'en-us': 'events/sorrento-peninsula/sagra-limone-massa-lubrense', 'de-de': 'veranstaltungen/sorrentiner-halbinsel/sagra-limone-massa-lubrense', 'fr-fr': 'evenements/peninsule-sorrentine/sagra-limone-massa-lubrense', 'es-es': 'eventos/peninsula-sorrentina/sagra-limone-massa-lubrense', 'it-it': 'eventi/penisola-sorrentina/sagra-limone-massa-lubrense' },
  'sagra-melanzana-preazzano': { 'en-us': 'events/sorrento-peninsula/sagra-melanzana-preazzano', 'de-de': 'veranstaltungen/sorrentiner-halbinsel/sagra-melanzana-preazzano', 'fr-fr': 'evenements/peninsule-sorrentine/sagra-melanzana-preazzano', 'es-es': 'eventos/peninsula-sorrentina/sagra-melanzana-preazzano', 'it-it': 'eventi/penisola-sorrentina/sagra-melanzana-preazzano' },
  'sorrento-meeting-cultura': { 'en-us': 'events/sorrento-peninsula/sorrento-meeting-cultura', 'de-de': 'veranstaltungen/sorrentiner-halbinsel/sorrento-meeting-cultura', 'fr-fr': 'evenements/peninsule-sorrentine/sorrento-meeting-cultura', 'es-es': 'eventos/peninsula-sorrentina/sorrento-meeting-cultura', 'it-it': 'eventi/penisola-sorrentina/sorrento-meeting-cultura' },
  ...
  'cala-mitigliano': { 'en-us': 'beaches/sorrentine-peninsula/cala-mitigliano', 'de-de': 'strande/sorrentiner-halbinsel/cala-mitigliano', 'fr-fr': 'plages/peninsule-sorrentine/cala-mitigliano', 'es-es': 'playas/peninsula-sorrentina/cala-mitigliano', 'it-it': 'spiagge/penisola-sorrentina/cala-mitigliano' },
  'marina-del-cantone': { 'en-us': 'beaches/sorrentine-peninsula/marina-del-cantone', 'de-de': 'strande/sorrentiner-halbinsel/marina-del-cantone', 'fr-fr': 'plages/peninsule-sorrentine/marina-del-cantone', 'es-es': 'playas/peninsula-sorrentina/marina-del-cantone', 'it-it': 'spiagge/penisola-sorrentina/marina-del-cantone' },
  'regina-giovanna': { 'en-us': 'beaches/sorrentine-peninsula/regina-giovanna', 'de-de': 'strande/sorrentiner-halbinsel/regina-giovanna', 'fr-fr': 'plages/peninsule-sorrentine/regina-giovanna', 'es-es': 'playas/peninsula-sorrentina/regina-giovanna', 'it-it': 'spiagge/penisola-sorrentina/regina-giovanna' },
  'spiaggia-di-ieranto': { 'en-us': 'beaches/sorrentine-peninsula/spiaggia-di-ieranto', 'de-de': 'strande/sorrentiner-halbinsel/spiaggia-di-ieranto', 'fr-fr': 'plages/peninsule-sorrentine/spiaggia-di-ieranto', 'es-es': 'playas/peninsula-sorrentina/spiaggia-di-ieranto', 'it-it': 'penisola-sorrentina/spiaggia-di-ieranto' },
  ...
  'sorrentine-peninsula-from-naples': { 'en-us': 'itineraries/1-day/sorrentine-peninsula-from-naples', 'de-de': 'reiserouten/1-tag/sorrentiner-halbinsel-von-neapel', 'fr-fr': 'itineraires/1-jour/peninsule-sorrentine-depuis-naples', 'es-es': 'itinerarios/1-dia/peninsula-sorrentina-desde-napoles', 'it-it': 'itinerari/1-giorno/penisola-sorrentina-da-napoli' },
...
export const pathSegments: Array<Record<Locale, string>> = [
  ...
  { 'en-us': 'sorrento-peninsula',    'en-gb': 'sorrento-peninsula',   'de-de': 'sorrentiner-halbinsel', 'fr-fr': 'peninsule-sorrentine',  'es-es': 'peninsula-sorrentina',  'it-it': 'penisola-sorrentina'  },
  ...
  { 'en-us': 'sorrentine-peninsula-from-naples',  'en-gb': 'sorrentine-peninsula-from-naples',  'de-de': 'sorrentiner-halbinsel-von-neapel','fr-fr': 'peninsule-sorrentine-depuis-naples','es-es': 'peninsula-sorrentina-desde-napoles','it-it': 'penisola-sorrentina-da-napoli'     },
